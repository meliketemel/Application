...
$scope.schedule=function()
{
	...
	//   $scope.customerseatbooking.deptime=entdate.concat(" ").concat(stime);
	  ...
	  $scope.customerseatbooking=response.data;
	  for(var i=0;i<$scope.customerseatbooking.length;i+=1)
	  {
	  $scope.customerseatbooking[i].busdetails.busname="";
	  $scope.customerseatbooking[i].startpoint="";
	  $scope.customerseatbooking[i].endpoint="";
	  $scope.customerseatbooking[i].deptime={};
	  $scope.customerseatbooking[i].arrtime={};
	  }
