...
<body>
  <div data-ng-controller="HomeController">
	...
	<div class="container-fluid mt-3 bg-info">
	   <div class="btn-group-lg">
	    <button type="button" class="btn btn-info" data-target="#singlebusregistration" data-toggle="pill">Customer Registration</button>
	    <button type="button" class="btn btn-info" data-target="#customerseatbooking" data-toggle="pill">Customer Seat Booking</button>
		<button type="button" class="btn btn-info" data-target="#busschedule" data-toggle="pill">Bus Schedule</button>
	   </div>
    </div>
  ...
  <div class="container-fluid mt-3">
  	<div class="tab-content">
		<div id="singlebusregistration" class="tab-pane fade">
		...
		<div id="busschedule" class="tab-pane fade">
